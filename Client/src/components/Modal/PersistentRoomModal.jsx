// src/components/Modal/PersistentRoomModal.jsx
import { useNavigate } from "react-router-dom";
import { X } from "lucide-react";
import { motion } from "framer-motion";

const PersistentRoomModal = ({ onclose }) => {
  const navigate = useNavigate();

  const handleCreate = () => {
    onclose();
    navigate("/persistent/create");
  };

  const handleJoin = () => {
    onclose();
    navigate("/persistent/join");
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <h2 className="text-2xl font-bold dark:text-white">Persistent Room</h2>
...
export default PersistentRoomModal;
